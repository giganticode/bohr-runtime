...
from bohr.util.paths import AbsolutePath, relative_to_safe

logger = logging.getLogger(__name__)


def md5_folder(
    path: AbsolutePath, project_root: AbsolutePath, python_files: bool = True
) -> Dict[str, str]:
    res: Dict[str, str] = {}
...
def update_lock(path_config: Optional[PathConfig] = None) -> None:
